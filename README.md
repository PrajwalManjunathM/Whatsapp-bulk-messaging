...
Uses pywhatkit to open WhatsApp Web with the specified phone number.
Waits for 10 seconds to ensure the initial image is sent.
Uses Selenium to:
...
Open WhatsApp Web for each contact.
Send the image along with the caption provided in the message variable.
